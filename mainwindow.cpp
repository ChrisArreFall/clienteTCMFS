...
int MainWindow::send(QString video){
    ...
    const char* nombreVideoFullPath=video.toStdString().c_str();
...
{
    limpiarCarpeta(boost::filesystem::path("/Users/Christopher/clienteTCMFS/VideosTemp"));
    ...
    int counter=0;
    const char* basePath = "/Users/Christopher/clienteTCMFS/VideosTemp/";
